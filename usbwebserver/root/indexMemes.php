...
<html lang = "en">
   ...
   <head>
      ...
      <style>
         body {
            ...
            background-image:url(http://getwallpapers.com/wallpaper/full/d/c/9/57345.jpg);background-repeat:no-repeat;background-size:cover;overflow-x:hidden;>
         }
   ...
   <body>
      ...
      <div class = "container">
	     ...
	     <a  style="font-size:300%;background-color:yellow" href = "indexMemesier.php" tite = "Logout">Fuck go back!
      </div>
